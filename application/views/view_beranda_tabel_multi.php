...
<thead>
          <tr>
              ...
              <th data-field="gambar">IVA Original</th>
...
?>
         <tr>
           ...
           <td>
            <a href="<?php echo $iva_ori ?>" data-lightbox="iva_ori" data-title="<?php echo $nama ?> | <?php echo date_format($tanggal, "d/M/y h:m:s") ?> | Kecamatan: <?php echo $kecamatan; ?> | Setelah ditetesi Acetat Acid"><img class="example-image" src="<?php echo $iva_ori;?>" width="100" height="100"></a>
           </td>
            <td>
